(() => {
  ...
  e.popup = new (class {
    ...
    _focusCatch(e) {
      ...
      e.shiftKey && 0 === o && (s[s.length - 1].focus(), e.preventDefault()),
        e.shiftKey || o !== s.length - 1 || (s[0].focus(), e.preventDefault());
    }
    _focusTrap() {
  ...
  new c("max").init(),
    ...
    document.addEventListener("click", function (e) {
      ...
      if (t.closest("[data-submenu-btn]")) {
        var s = t.closest("[data-submenu-btn]"),
          o = s.dataset.submenuBtn,
          i = document.querySelector(`[data-submenu="${o}"]`);
        if (i) {
          var n = document.querySelector(".submenu-header__block_active"),
            r = document.querySelector(".menu-catalog__button_active");
          n &&
            n !== i &&
            (n.classList.remove("submenu-header__block_active"),
            r.classList.remove("menu-catalog__button_active")),
            i.classList.toggle("submenu-header__block_active"),
            s.classList.toggle("menu-catalog__button_active");
        }
      }
    ...
    (function () {
      ...
      if (e.length > 0) {
        const o = Array.from(e).filter(function (e, t, s) {
        ...
        function l(e) {
          ...
          if (o.closest("[data-spoller]")) {
            ...
            n.querySelectorAll("._slide").length ||
              (r && !i.classList.contains("_spoller-active") && c(n),
              i.classList.toggle("_spoller-active"),
              ((e, o = 500) => {
                e.hidden ? s(e, o) : t(e, o);
        ...
        function c(e) {
          const s = e.querySelector("[data-spoller]._spoller-active"),
            o = e.dataset.spollersSpeed
              ? parseInt(e.dataset.spollersSpeed)
              : 500;
          s &&
            !e.querySelectorAll("._slide").length &&
            (s.classList.remove("_spoller-active"), t(s.nextElementSibling, o));
        }
        i &&
          i.length &&
          i.forEach((e) => {
